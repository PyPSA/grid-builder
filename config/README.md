...
- `config/config.yaml`: the default configuration of this module.
- `config/config.schema.json`: a schematic overview of all the configuration options of this module.
